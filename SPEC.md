...
| 16 | `/products` page v2 "the bundles": eight joke bundles since 2026-09-06 (FinanceBro Starter Pack 6 - Birkin card shows a gold croc clutch, BWL Marie 7, Undercover Broke Student 6, Excel Monkey 4, Doomsday Bunker 4, LinkedIn Thought Leader 4, Boring Index Fund 4, After-Exam Party Kit 6: Aperol tower, beer mortar opener, beer pong, shot roulette, spritz glasses, party speaker) in a 2-col card grid; images are Adobe Stock (free tier, licensed on Nico's account, committed under `public/products/`, scouted 5+ candidates each), object-contain so nothing crops; live Amazon search links (tag pending), Birkin sold-out gag, compact § 5a UWG disclosure; ketchup + cigarettes removed 2026-08-29 per Nico | done - tag TODO in `src/lib/affiliate.ts` |
