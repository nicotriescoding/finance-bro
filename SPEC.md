...
| 16 | `/products` page v2 "the bundles": three joke bundles (FinanceBro Starter Pack, Undercover Broke Student, BWL Marie), 21 products in a 2-col card grid, every Wikimedia image eye-verified + object-contain (no more wrong crops), live Amazon search links (tag pending), Birkin sold-out gag, compact § 5a UWG disclosure + photo credits | done - tag TODO in `src/lib/affiliate.ts` |
